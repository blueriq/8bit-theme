...
describe('FileUploadComponent', () => {
  ...
  it('should show progress bar when needed', () => {
    ...
    let progressBar = component.nativeElement.querySelector('.nes-progress');
    ...
    progressBar = component.nativeElement.querySelector('.nes-progress');
  ...
  it('should display a hint messages for the upload criteria', () => {
    // Init
    const hints = component.nativeElement.querySelectorAll('.hint');
  ...
  it('should display an error message when file type is incorrect', () => {
    ...
    component.detectChanges();
    const errors = component.nativeElement.querySelectorAll('.error');
  ...
  it('should use the .title class to display header', () => {
    // Verify
