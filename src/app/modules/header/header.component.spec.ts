...
describe('HeaderComponent', () => {
  ...
  describe('basic behavior', () => {
    ...
    it('should render properly', () => {
      expect(fixture.nativeElement.querySelector('h1').innerText).toBe('blueriq');
  ...
  describe('rendered with dashboard_header', () => {
    ...
    it('should render properly', () => {
      expect(fixture.nativeElement.querySelector('h1').innerText).toBe('blueriq');
      expect(fixture.nativeElement.querySelector('h2').innerText).toBe('Page Title');
      expect(fixture.nativeElement.querySelector('button').innerText.toLowerCase()).toBe('requester logoff');
    });
  });
  ...
  describe('rendered with dashboard_header and no username', () => {
    ...
    it('should render properly', () => {
      expect(fixture.nativeElement.querySelector('h1').innerText).toBe('blueriq');
      expect(fixture.nativeElement.querySelector('h2').innerText).toBe('Page Title');
      expect(fixture.nativeElement.querySelector('button').innerText.toLowerCase()).toBe('logoff');
