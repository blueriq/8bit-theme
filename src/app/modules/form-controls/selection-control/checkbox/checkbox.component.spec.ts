...
describe('CheckboxComponent', () => {
  ...
  it('should be changed', () => {
    ...
    let inputField = component.nativeElement.querySelector('input[type=checkbox]');
    ...
    inputField = component.nativeElement.querySelector('input[type=checkbox]');
  ...
  it('should be disabled', () => {
    ...
    const inputField = component.nativeElement.querySelector('input[type=checkbox][disabled]');
