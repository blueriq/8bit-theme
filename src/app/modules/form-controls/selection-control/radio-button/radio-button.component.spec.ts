...
describe('RadioButtonComponent', () => {
  ...
  it('should be checked', () => {
    let inputField = component.nativeElement.querySelector('input[type=radio]:checked');
    expect(inputField).toBeFalsy('by default nothing is checked');

    session.update(
      field.value('beaker'),
    );
    inputField = component.nativeElement.querySelector('input[type=radio]:checked');
  ...
  it('default direction is `vertical`', () => {
    let styledDiv = component.nativeElement.querySelector('section').querySelector('div');
    ...
    styledDiv = component.nativeElement.querySelector('section').querySelector('div');
